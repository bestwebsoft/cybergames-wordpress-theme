...
function cybergames_admin_header_image() { ?>
	<div class="site-title">
		<?php if ( ! display_header_text() ) { ?>
			<h1 class="cybergames-site-title displaying-header-text" style="display: none;"><a id="name" href="<?php echo esc_url( home_url() ); ?>"><?php bloginfo( 'name' ); ?></a></h1>
			<p class="site-description displaying-header-text" id="desc" style="display: none;"><?php bloginfo( 'description' ); ?></p>
		<?php } else { ?>
			<h1 class="cybergames-site-title displaying-header-text"><a id="name" href="<?php echo esc_url( home_url() ); ?>" style="color: #<?php echo get_header_textcolor(); ?>;"><?php bloginfo( 'name' ); ?></a></h1>
...
function cybergames_custom_header() {
	if ( get_header_image() )
		printf( '<div id="cbg-custom-image-image" class="aligncenter"><img src="%s" width="%dpx" height="%dpx"></div><!--.cbg-custom-image-image-->', get_custom_header()->url, get_custom_header()->width, get_custom_header()->height );
}
...
add_filter( 'wp_title', 'cybergames_wp_title', 10, 2 );
